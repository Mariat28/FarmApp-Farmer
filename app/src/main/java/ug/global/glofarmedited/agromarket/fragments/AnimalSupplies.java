...
public class AnimalSupplies extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_animal_supplies, container, false);
        ...
        adapter = new SupplierAdapter(supplierObjectsArrayList, getContext());
        reference = FirebaseDatabase.getInstance().getReference("/supplies");
        query1 = reference.orderByChild("supplytype").equalTo("Animal Supply");
                ...
                public void onClick(View v) {
                    searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                        ...
                        public boolean onQueryTextSubmit(String submittedtext) {
                            ...
                            Toast.makeText(getActivity(), "This is the submitted text" + submittedtext, Toast.LENGTH_SHORT).show();
                            Query query = reference.orderByChild("supplyname").equalTo(submittedtext);
                        ...
                        public boolean onQueryTextChange(String newText) {
                            ...
                            if (newText.length() == 0) {
                                ...
                                Query query = reference.orderByChild("supplyname").startAt(newText);
                                query.addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        Iterable<DataSnapshot> snapshotIterable = dataSnapshot.getChildren();
