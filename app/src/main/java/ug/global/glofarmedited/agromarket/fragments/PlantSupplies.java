...
public class PlantSupplies extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query query = reference.orderByChild("supplytype").equalTo("Plant Supply");
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                String toolsavailable = hashMap.get("availableamount");
                SupplierObjects supplyObjects = new SupplierObjects(name, price, toolsavailable, R.drawable.ic_account_circle_black_24dp);
